...
{                                                                             }
{ Version 2.1-xix-1 (December 2013) by Bart Dezitter                          }
{ e-mail: info@xixmusicplayer.org                                             }
{   - updated to unicode file access                                          }
{   - Removed uses of TntClasses                                              }
{                                                                             }
...
type
  ...
  TAPETag = class
    ...
    public
      ...
      property Filesize: Longint read pFileSize;
      constructor Create();
...
if (Result) and (Footer.ID = APE_ID) then
begin
  SourceFile := TFileStreamUTF8.Create(sFile, fmOpenReadWrite or fmShareDenyWrite);
