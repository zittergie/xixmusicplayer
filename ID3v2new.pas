...
type
  ...
  TID3v2 = class(TObject)
    ...
    public
      ...
      property OriginalArtist: string read FOriginalArtist write FSetOriginalArtist;             { URL link }
...
begin
  ...
  Result := false;
  if (not FileExists(FileName)) {or (WideFileSetAttr(FileName, 0) <> True)} then exit;
...
begin
{ Set artist name }
FArtist := Trim(NewOriginalArtist);
end;
